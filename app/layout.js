...
function MobileMenu(){return React.createElement(React.Fragment,null,React.createElement('input',{id:'global-mobile-menu',className:'globalMobileToggle',type:'checkbox','aria-label':'Abrir menu principal'}),React.createElement('label',{className:'globalMobileButton',htmlFor:'global-mobile-menu','aria-label':'Abrir menu principal'}),React.createElement('nav',{className:'globalMobilePanel','aria-label':'Menu principal mobile'},React.createElement('div',{className:'globalMobileTitle'},'Menu principal'),React.createElement('div',{className:'globalMobileGrid'},React.createElement('a',{href:'/'},'Início'),React.createElement('a',{href:'/quem-somos'},'Quem somos'),React.createElement('a',{href:'/campanhas'},'Campanhas'),React.createElement('a',{href:'/voluntariado'},'Voluntariado'),React.createElement('a',{className:'adminLink',href:'/admin'},'Área administrativa ↗')),React.createElement('div',{className:'globalMobileInstitutional'},React.createElement('a',{className:'actionDeskStyle',href:'/campanhas'},'Lions em ação'),React.createElement('a',{className:'historyDeskStyle',href:'/historia'},'História'),React.createElement('a',{className:'transparencyDeskStyle',href:'/transparencia'},'Transparência'),React.createElement('a',{className:'juazeiroDeskStyle',href:'/juazeiro-do-norte'},'Juazeiro'),React.createElement('a',{className:'directorDeskStyle',href:'/diretoria'},'Diretoria'),React.createElement('a',{className:'portalDeskStyle',href:'/admin'},'Portal interno'),React.createElement('a',{className:'contactDeskStyle',href:'/voluntariado'},'Contato')),React.createElement('div',{className:'globalMobileActions'},React.createElement('a',{className:'globalParticipar',href:'/voluntariado'},'Participar'),React.createElement('a',{className:'globalApoiar',href:'/campanhas'},'Apoiar'))));}

export default function RootLayout(props){return React.createElement('html',{lang:'pt-BR'},React.createElement('body',null,props.children,React.createElement('style',{id:'layout-overrides',dangerouslySetInnerHTML:{__html:layoutCss}}),React.createElement(MobileMenu),React.createElement(InstagramButton)));}
